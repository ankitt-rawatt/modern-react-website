...
export default function Pricing(){
    ...
    <section id="pricing" className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid drid-cols-1 md:grid-cols2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
            {plans.map((plans,key) => (
              ...
              <div className="absolute inset-0 bg-linear-to-br from-white/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform -translate-x-full -translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 pointer-events-none rounded-lg" />
                    ...
                    <div className="text-center mb-6 sm:mb:8">
                        ...
                        <div className="flex items-baseline justify-center">
                            <span className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">{plans.price}</span>
                    ...
                    <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row">
                     ...
                     ${plans.mostPopular ? "bg-linear-to-b from-blue-500 to-cyan-500" : "bg-white/5 border border-white/10 hover:bg-white/10"}`}>
                        Get Started
                     </button>
        ...
        <div className="mt-8 sm:mt-12 text-center">
            <p className="text-gray-400 text-xl">
                Need a custom plan?
                <a href="#" className="text-blue-400 hover:text-blue-300 px-2">Contact our sales team</a>
            </p>
        </div>
