...
import { NewTwitterIcon, GithubIcon, Linkedin02Icon, Mail01Icon } from "@hugeicons/core-free-icons";
        ...
        <div className="hidden sm:grid sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4">
              ...
              >
                <HugeiconsIcon icon={NewTwitterIcon} className="w-5 h-5 sm:w-5 sm:h-5" />
              ...
              <a
                ...
                className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"
              >
                <HugeiconsIcon icon={GithubIcon} className="w-5 h-5 sm:w-5 sm:h-5" />
              </a>
              <a
                href="#"
                className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"
              >
                <HugeiconsIcon icon={Linkedin02Icon} className="w-5 h-5 sm:w-5 sm:h-5" />
              </a>
              <a
                href="#"
                className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"
              >
                <HugeiconsIcon icon={Mail01Icon} className="w-5 h-5 sm:w-5 sm:h-5" />
              </a>
            </div>
          </div>
